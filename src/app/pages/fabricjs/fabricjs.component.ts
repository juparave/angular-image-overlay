...
export class FabricjsComponent implements OnInit {
  ...
  method2() {
    ...
    fabric.Image.fromURL(
      'https://github.com/juparave/angular-image-overlay/raw/master/src/assets/TL-5150-CAN.png',
      (img) => {
        img.set({
  ...
  addOther() {
    //  Method 2 (add by picture path)
    fabric.Image.fromURL(
      'https://github.com/juparave/angular-image-overlay/raw/master/src/assets/TR-2404.B.png',
      (img) => {
        img.set({
          left: 100, //  Image of the picture relative to the left side of the canvas
          top: 100, //  Picture of the top distance of the canvas
